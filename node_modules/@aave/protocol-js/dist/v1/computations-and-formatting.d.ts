...
export declare type GetReserveNormalizedIncomeReserve = Pick<ReserveData, 'liquidityRate' | 'liquidityIndex' | 'lastUpdateTimestamp'>;
export declare function getReserveNormalizedIncome(reserve: GetReserveNormalizedIncomeReserve, currentTimestamp: number): BigNumber;
export declare type CalculateCumulatedBalancePoolReserve = GetReserveNormalizedIncomeReserve;
