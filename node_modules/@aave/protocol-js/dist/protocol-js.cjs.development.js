...
function calculateHealthFactorFromBalancesBigUnits(collateralBalanceETH, borrowBalanceETH, totalFeesETH, currentLiquidationThreshold) {
  return calculateHealthFactorFromBalances(collateralBalanceETH, borrowBalanceETH, totalFeesETH, new BigNumber__default(currentLiquidationThreshold).multipliedBy(100).decimalPlaces(0, BigNumber__default.ROUND_DOWN));
}
...
function calculateAverageRate(index0, index1, timestamp0, timestamp1) {
  return new BigNumber__default(index1).dividedBy(index0).minus('1').dividedBy(timestamp1 - timestamp0).multipliedBy('31536000').toString();
}
...
function calculateHealthFactorFromBalancesBigUnits$1(collateralBalanceETH, borrowBalanceETH, currentLiquidationThreshold) {
  return calculateHealthFactorFromBalances$1(collateralBalanceETH, borrowBalanceETH, new BigNumber__default(currentLiquidationThreshold).multipliedBy(pow10(LTV_PRECISION)).decimalPlaces(0, BigNumber__default.ROUND_DOWN));
}
...
var enabledNetworksByService = {
  ...
  lendingPool: (_lendingPool = {}, _lendingPool[exports.Market.Proto] = [exports.Network.kovan, exports.Network.mainnet], _lendingPool),
  governance: [exports.Network.kovan, exports.Network.mainnet],
  wethGateway: [exports.Network.kovan, exports.Network.mainnet],
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (!(_this.config.network === exports.Network.ropsten)) {
                  _context.next = 3;
                  break;
                }
...
var BaseTxBuilder = function BaseTxBuilder(network, injectedProvider, defaultProviderKeys) {
  ...
  if (!injectedProvider) {
    ...
    provider = new ethers.providers.JsonRpcProvider(injectedProvider, network);
  } else if (injectedProvider instanceof ethers.providers.Web3Provider) {
    provider = injectedProvider;
  } else {
    provider = new ethers.providers.Web3Provider(injectedProvider, network);
  }
...
exports.calculateAvailableBorrowsETH = calculateAvailableBorrowsETH$1;
exports.calculateAverageRate = calculateAverageRate$1;
exports.calculateCompoundedInterest = calculateCompoundedInterest$1;
exports.calculateHealthFactorFromBalances = calculateHealthFactorFromBalances$1;
exports.calculateHealthFactorFromBalancesBigUnits = calculateHealthFactorFromBalancesBigUnits$1;
