...
export default class LendingPool extends BaseService<ILendingPool> implements LendingPoolInterface {
    ...
    liquidationCall({ liquidator, liquidatedUser, debtReserve, collateralReserve, purchaseAmount, getAToken, }: LPLiquidationCall): Promise<EthereumTransactionTypeExtended[]>;
