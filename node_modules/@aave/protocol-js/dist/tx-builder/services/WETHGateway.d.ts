...
export default class WETHGatewayService extends BaseService<IWETHGateway> implements WETHGatewayInterface {
    ...
    depositETH({ user, amount, onBehalfOf, referralCode }: WETHDepositParamsType): Promise<EthereumTransactionTypeExtended[]>;
    borrowETH({ user, amount, debtTokenAddress, interestRateMode, referralCode, }: WETHBorrowParamsType): Promise<EthereumTransactionTypeExtended[]>;
    withdrawETH({ user, amount, onBehalfOf, aTokenAddress }: WETHWithdrawParamsType): Promise<EthereumTransactionTypeExtended[]>;
    repayETH({ user, amount, interestRateMode, onBehalfOf }: WETHRepayParamsType): Promise<EthereumTransactionTypeExtended[]>;
}
